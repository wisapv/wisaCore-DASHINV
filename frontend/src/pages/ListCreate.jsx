              ...
              {step === 'preview' && (
                <div className="flex flex-col gap-6">
                  ...
                  {tbosRemindData && tbosRemindData.length > 0 && (
                    <div className="bg-red-50/50 border border-red-100 rounded-[24px] p-6 animate-in fade-in slide-in-from-bottom-6">
                          ...
                          <tbody className="divide-y divide-red-50">
                            {tbosRemindData.map((r, i) => (
                              <tr key={i} className="hover:bg-red-50/30 transition-colors">
                                <td className="px-4 py-3 font-medium text-dark">{r['Dock IH']}</td>
                                <td className="px-4 py-3 text-dark">{r.Supplier}</td>
                                <td className="px-4 py-3 font-mono text-dark">{r['Part No']}</td>
                                <td className="px-4 py-3 text-dark">{r.Source}</td>
                              </tr>
                            ))}
                          </tbody>
                        </table>
